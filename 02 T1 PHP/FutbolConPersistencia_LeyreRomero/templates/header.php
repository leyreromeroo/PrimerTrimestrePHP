 ...
 */
  ...
  // Ruta relativa al CSS
    $bootstrapPath = $urlApp .'/assets/css/bootstrap.css';
    $indexPath = $urlApp .'/index.php';
    $signupPath = $urlApp .'/app/signup.php';
    $loginPath = $urlApp .'/app/login.php';
    $logOutPath = $urlApp .'/app/logout.php';
...
<?php
  ...
  ?>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <a class="navbar-brand" href="<?= $indexPath ?>">Artean</a>

        <div class="collapse navbar-collapse" id="navbarToggler">
            <ul class="navbar-nav mr-auto mt-2 mt-md-0">
                <li class="nav-item">
                    <a class="nav-link" href="<?= $logOutPath ?>">Salir</a>
                </li>
            </ul>
        </div>
    </nav>
  ...
  ?>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarToggler">
            <ul class="navbar-nav mr-auto mt-2 mt-md-0">
                <li class="nav-item">
                    <a class="nav-link" href="<?= $signupPath ?>">Registrarse</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?= $loginPath ?>">Entrar</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?= $logOutPath ?>">Salir</a>
                </li>
...
<script src="/Trabajos DW/PrimerTrimestrePHP/02 T1 PHP/ArteanV1/assets/js/bootstrap.js"></script>
